                ...
                <nav style={{ borderBottom: '1px solid #c1c0c04a' }} id='navBarHeader' className="transition-all duration-500 flex items-center justify-between flex-wrap bg-white py-2 px-4 fixed w-full z-10 top-0">
                    <div className="flex items-center flex-shrink-0 text-white mr-4">
                        <NavLink to='/' aria-label="Back to homepage" className="flex items-center">
                            ...
                            {/* <svg fill="#000000" width="800px" height="800px" viewBox="0 0 64 64" className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className='text-xl font-medium text-blue-500 sm:text-2xl '>HD CINEMA</span> */}
                    ...
                    <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden  pt-3 lg:pt-0"
                        ...
                        <ul className="list-reset lg:flex justify-start flex-1 items-center mb-0 pl-12">
                            <li className="mr-3">
                                <Link to='/#movie-list' className="inline-block py-2 px-4 text-black font-medium md:text-base hover:text-blue-600 no-underline" >Phim</Link>
                            </li>
                            <li className="mr-3">
