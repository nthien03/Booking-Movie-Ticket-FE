...
export default function HomeCarousel() {
    ...
    // useEffect(() => {
    //     // Giả sử dữ liệu banner bạn muốn lấy từ API
    //     const bannerData = [
    //         { maBanner: 1, link: 'https://www.youtube.com/watch?v=rcpuVDA9JPY', img: avatar },
    //         { maBanner: 2, link: 'https://www.youtube.com/watch?v=7Ma1uab-bQM&t=4s', img: onepiece },
    //         { maBanner: 3, link: 'https://www.youtube.com/watch?v=fovTZDDPgAQ', img: pussInBoots },
    //     ];
                ...
                {dataBanner.map((item, index) => {
                    return <div key={index}>
                        ...
                        <button onClick={() => showModal(item.link)}>
                            ...
                            {/* <img src={logo_client} alt="logo_client" className="w-24 h-20 object-contain" /> */}
                        </button>
                        {isModalOpen ? <Modal
                            footer={null}
                            centered
